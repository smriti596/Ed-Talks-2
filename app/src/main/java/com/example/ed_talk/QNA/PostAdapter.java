...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull @NotNull PostAdapter.ViewHolder holder, int position) {
        ...
        setPublisherInfo(holder.askedByTextView,holder.publisherProfileImage, post.getPublisher());
    ...
    private void setPublisherInfo( TextView usernameTextView,ImageView publisherImage, String userID) {
